...
import { ArrowLeft, ShieldCheck, Briefcase, Zap, Search, CheckCircle2, User, Award, Loader2, LogOut, Copy, Check, LayoutDashboard, FileText, Fingerprint, Shield, ClipboardList } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black font-sans text-white">
      <header className="px-10 py-6 flex justify-between items-center border-b border-zinc-800 bg-black/50 backdrop-blur-2xl sticky top-0 z-50">
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-3">
             ...
             <span className="text-2xl font-black tracking-tighter uppercase italic">Proof Terminal</span>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-4">
            ...
            <Link href="/recruiter/candidates" className="flex items-center gap-2 px-4 py-2 text-zinc-400 hover:text-white transition-colors text-xs font-black uppercase tracking-widest">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full p-8 lg:p-12">
        <div className="mb-12">
           <h2 className="text-4xl font-black italic uppercase tracking-tightest mb-2">Verification Terminal</h2>
           <p className="text-zinc-500 text-sm font-medium italic">Manually verify proof hashes against the Midnight ledger.</p>
        </div>
      ...
      <footer className="px-10 py-8 border-t border-zinc-800 text-center flex flex-col md:flex-row items-center justify-between">
        <div className="flex items-center gap-6">
           <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">
              On-Chain Verification Engine Active
           </span>
        ...
        <div className="mt-4 md:mt-0 text-[11px] font-black text-zinc-400 uppercase tracking-widest flex items-center gap-2">
           Node: <span className="text-indigo-600 bg-indigo-900/20 px-3 py-1 rounded-lg italic">Midnight-Testnet-v4</span>
        </div>
        <div className="mt-4 md:mt-0 text-zinc-400 text-[10px] font-black uppercase tracking-widest">
          All verifications are recorded on the Midnight ledger
        </div>
      </footer>
    </div>
  );
