...
import { ArrowLeft, ShieldCheck, Briefcase, Zap, Lock, Globe, Loader2, Fingerprint, Search, CheckCircle2, AlertTriangle, ExternalLink, Info } from 'lucide-react';
...
export default function RecruiterAuthPage() {
  ...
  useEffect(() => {
    ...
    if (savedConnected === 'true' && role === 'recruiter') {
      handleConnect(true);
    }
  }, []);
      ...
      <main className="relative z-10 w-full max-w-7xl px-8 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-32 py-20">
        ...
        >
           ...
           <div className="relative aspect-square rounded-[4rem] border border-white/10 overflow-hidden shadow-3xl flex items-center justify-center bg-zinc-900/30 backdrop-blur-3xl group">
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=2000')] bg-cover bg-center opacity-30 grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000"></div>
              ...
              >
                 ...
                 <div className="space-y-4 text-center">
                    <h3 className="text-2xl font-black italic uppercase tracking-tighter">Recruiter Node</h3>
        ...
        >
           <div className="bg-zinc-900/60 backdrop-blur-3xl border border-white/10 rounded-[3.5rem] shadow-3xl overflow-hidden flex flex-col">
              <div className="p-12 pb-8 flex flex-col items-center text-center">
                 ...
                 <h2 className="text-3xl font-black italic uppercase tracking-tightest mb-4">Recruiter Terminal</h2>
