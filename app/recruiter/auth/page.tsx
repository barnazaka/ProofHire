  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-indigo-500 selection:text-white overflow-hidden relative flex items-center justify-center">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-indigo-900/10 via-black to-purple-900/10 opacity-50"></div>
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-indigo-600/10 blur-[150px] rounded-full animate-pulse"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-purple-600/10 blur-[150px] rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <main className="relative z-10 w-full max-w-7xl px-8 flex flex-col lg:flex-row-reverse items-center justify-center gap-16 lg:gap-32">
        {/* Visual Decoration */}
        <motion.div
        ...
        >
           ...
           <div className="relative aspect-square rounded-[4rem] border border-white/10 overflow-hidden shadow-3xl flex items-center justify-center bg-zinc-900/30 backdrop-blur-3xl group">
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&q=80&w=2000')] bg-cover bg-center opacity-30 grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000"></div>
