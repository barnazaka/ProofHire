      ...
      <main className="flex-1 flex flex-col justify-center items-center max-w-6xl mx-auto px-8 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-4xl">
           <Link href="/talent/login" className="group relative">
              <div className="p-12 h-full bg-zinc-50 dark:bg-zinc-900 rounded-[4rem] border border-zinc-200 dark:border-zinc-800 transition-all duration-500 hover:scale-[1.02] hover:border-indigo-600 flex flex-col items-center text-center">
                <div className="p-8 bg-zinc-100 dark:bg-zinc-800 rounded-[3rem] mb-8 group-hover:bg-indigo-600/10 transition-colors">
                  <User className="w-16 h-16 text-indigo-600" />
                </div>
                <h3 className="text-4xl font-black uppercase italic mb-6">Talent</h3>
                ...
                <div className="mt-auto px-8 py-4 bg-zinc-900 dark:bg-white text-white dark:text-black rounded-2xl font-black uppercase italic tracking-tighter group-hover:bg-indigo-600 group-hover:text-white transition-all">
                  Sign In
                </div>
              </div>
           </Link>
           ...
           <Link href="/recruiter/login" className="group relative">
              <div className="p-12 h-full bg-zinc-50 dark:bg-zinc-900 rounded-[4rem] border border-zinc-200 dark:border-zinc-800 transition-all duration-500 hover:scale-[1.02] hover:border-indigo-600 flex flex-col items-center text-center">
                ...
                <h3 className="text-4xl font-black uppercase italic mb-6">Recruiter</h3>
                <p className="text-zinc-500 dark:text-zinc-400 font-medium mb-12">
