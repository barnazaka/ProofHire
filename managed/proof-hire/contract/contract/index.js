...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      submitProof: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(user_0).concat(_descriptor_1.toValue(proof_0).concat(_descriptor_0.toValue(cType_0))),
      ...
      verifyCandidateClaim: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`verifyCandidateClaim: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const pHash_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyCandidateClaim',
                                     'argument 1 (as invoked from Typescript)',
                                     'proof-hire.compact line 13 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(pHash_0),
        ...
        const result_0 = this._verifyCandidateClaim_0(context,
                                                      partialProofData,
                                                      pHash_0);
    ...
    this.impureCircuits = {
      ...
      verifyCandidateClaim: this.circuits.verifyCandidateClaim
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('verifyCandidateClaim', new __compactRuntime.ContractOperation());
  ...
  _submitProof_0(context, partialProofData, user_0, proof_0, cType_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(0n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(user_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(1n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(proof_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(2n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(cType_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
  _verifyCandidateClaim_0(context, partialProofData, pHash_0) {
